...
class hashtaggeneratorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/hashtaggenerator');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"count":{"type":"number","required":false,"default":"5"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/hashtaggenerator`);
        }
    }
...
module.exports = hashtaggeneratorWrapper;
