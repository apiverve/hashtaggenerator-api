...
namespace APIVerve\Hashtaggenerator;
...
/**
 * Client for the Hashtag Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/hashtaggenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/hashtaggenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HashtaggeneratorClient] {$message}\n";
        }
    }
}
