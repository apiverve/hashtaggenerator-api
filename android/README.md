...
```gradle
dependencies {
    implementation 'com.github.apiverve:hashtaggenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.hashtaggenerator.HashtagGeneratorAPIClient;
import com.apiverve.hashtaggenerator.APIResponse;
import com.apiverve.hashtaggenerator.APIException;

// Initialize the client
HashtagGeneratorAPIClient client = new HashtagGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/hashtaggenerator](https://docs.apiverve.com/ref/hashtaggenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/hashtaggenerator](https://docs.apiverve.com/ref/hashtaggenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/hashtaggenerator-api/issues)
